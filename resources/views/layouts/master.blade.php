        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2 centered">
                    <h5>support@cachethq.io</h5>
                    <p class="mt">
                        <a href="https://twitter.com/cachethq" target="_blank"><i class="ion-social-twitter"></i></a>
                        <a href="https://facebook.com/cachethq" target="_blank"><i class="ion-social-facebook"></i></a>
                        <a href="https://github.com/cachethq" target="_blank"><i class="ion-social-github"></i></a>
                    </p>
                </div>
            </div>
        </div>
